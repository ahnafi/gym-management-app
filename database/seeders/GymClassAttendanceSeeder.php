    ...
    public function run(): void
    {
        $attendances = [
            ...
            [
                ...
                'attended_at' => Carbon::now()->subDays(10),
                'user_id' => 1,
                'gym_class_schedule_id' => 21,
            ],
            [
                'status' => 'assigned',
                'attended_at' => Carbon::now()->subDays(10),
                'user_id' => 1,
                'gym_class_schedule_id' => 11,
            ],
            [
                'status' => 'missed',
                'attended_at' => Carbon::now()->subDays(9),
                'user_id' => 1,
                'gym_class_schedule_id' => 17,
            ],
            [
                'status' => 'assigned',
                'attended_at' => Carbon::now()->subDays(7),
                'user_id' => 1,
                'gym_class_schedule_id' => 14,
            ],
            [
                'status' => 'attended',
                'attended_at' => Carbon::now()->subDays(10),
            ...
            [
                ...
                'attended_at' => Carbon::now()->subDays(9),
                'user_id' => 3,
                'gym_class_schedule_id' => 23,
            ],
            [
                'status' => 'attended',
                'attended_at' => Carbon::now()->subDays(7),
                'user_id' => 3,
                'gym_class_schedule_id' => 31,
            ],
            [
                'status' => 'attended',
                'attended_at' => Carbon::now()->subDays(10),
